...
if __name__ == '__main__':
    ...
    val_answers = utils.get_file(test=True, answer=True)
    
    # train_answers = json.load(open(os.path.join(config.main_path, 'v2_mscoco_train2014_annotations.json')))
    # val_answers = json.load(open(os.path.join(config.main_path, 'v2_mscoco_val2014_annotations.json')))
